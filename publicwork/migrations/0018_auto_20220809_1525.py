...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='historicofseeker',
            name='occurrence',
            field=models.CharField(choices=[('OBS', 'observation'), ('NEW', 'new'), ('MBR', 'member'), ('INS', 'installing'), ('ITD', 'installed'), ('STD', 'stand by'), ('RST', 'restriction')], default='MBR', max_length=3, verbose_name='occurrence'),
        ),
        migrations.AlterField(
            model_name='historicofseeker',
            name='seeker',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='publicwork.seeker', verbose_name='seeker'),
        ),
        migrations.AlterField(
            model_name='lecture',
            name='center',
        ...
        migrations.AlterField(
            model_name='lecture',
            name='listeners',
            field=models.ManyToManyField(blank=True, through='publicwork.Listener', to='publicwork.Seeker', verbose_name='listeners'),
        ),
        migrations.AlterField(
            model_name='lecture',
            name='theme',
        ...
        migrations.AlterField(
            model_name='lecture',
            name='type',
            field=models.CharField(choices=[('CTT', 'contact'), ('MET', 'meeting')], default='CTT', max_length=3, verbose_name='type'),
        ),
        migrations.AlterField(
            model_name='listener',
            name='lecture',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='publicwork.lecture', verbose_name='lecture'),
        ),
        migrations.AlterField(
            model_name='listener',
            name='observations',
        ...
        migrations.AlterField(
            model_name='publicworkgroup',
            name='members',
            field=models.ManyToManyField(blank=True, to='publicwork.Seeker', verbose_name='members'),
        ),
        migrations.AlterField(
            model_name='publicworkgroup',
            name='mentors',
            field=models.ManyToManyField(blank=True, to='person.Person', verbose_name='mentors'),
        ),
        migrations.AlterField(
            model_name='publicworkgroup',
            name='name',
        ...
        migrations.AlterField(
            model_name='seeker',
            name='country',
            field=models.CharField(choices=[('BR', 'Brazil')], default='BR', max_length=2, verbose_name='country'),
        ),
        migrations.AlterField(
            model_name='seeker',
            name='gender',
            field=models.CharField(choices=[('M', 'male'), ('F', 'female'), ('-', 'do not inform')], default='M', max_length=1, verbose_name='gender'),
        ),
        migrations.AlterField(
            model_name='seeker',
            name='image',
            field=models.ImageField(blank=True, default='default_profile.jpg', upload_to=publicwork.models.seeker_pics, verbose_name='image'),
        ),
        migrations.AlterField(
            model_name='seeker',
            name='is_active',
        ...
        migrations.AlterField(
            model_name='tempregofseeker',
            name='solicited_on',
            field=models.DateTimeField(default=django.utils.timezone.now, verbose_name='solicited on'),
        ),
        migrations.AlterField(
            model_name='tempregofseeker',
            name='state',
